...
export const postEvent = async (place, startData, endData, IdArray, limit, page, callback)=>{
    ...
    console.log('http://96cd-217-197-0-75.ngrok.io/timetable/search/?'+`limit=${limit}&`+ `page=${page}`);
    await axios({
        method: "post",
        url: 'http://96cd-217-197-0-75.ngrok.io/timetable/search/?'+`limit=${limit}&`+ `page=${page}`,
        data: bodyFormData
    }).then(response => {
...
export const postInformationFromEvents = async (place, IdArray, limit, page, callback)=>{
    ...
    await axios({
        method: "post",
        url: `http://96cd-217-197-0-75.ngrok.io/${place}/search_from_timetable/?`+`limit=${limit}&`+ `page=${page}`,
        data: IdMassif
    }).then(response => {
...
export const postChart = async (IdArray, param, date, callback, errorCallback)=>{
    ...
    await axios({
        method: "post",
        url: 'http://96cd-217-197-0-75.ngrok.io/timetable/graph',
        data: bodyFormData
    }).then(response => {
